...
export function isDependancyRedundant(dependencies: Map<string, Set<string>>, start: string, target: string): boolean {
...
export const umlTextDefault: string = `[XmsWebapp]<-[XmsOrders]
...
export function createDependenciesByPlugin(umlText: string): Map<string, Set<string>> {
